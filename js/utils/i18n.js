...
const translations = {
  ce: {
    ...
    "stats.taSection": "Хандехьа ⏱",
    "stats.taBest": "Уггаре дика",
    "stats.taGames": "Ловзарш",
    "stats.taWords": "Дешнаш",
    "stats.daily": "Денна дош",
    "stats.streakNow": "ХӀинцалера могӀа",
    "stats.streakBest": "Уггаре деха могӀа",
    "stats.coins": "Сом",
    ...
    "ta.home": "ТӀех",
    // Zincir
    "chain.title": "Дошан зӀенг",
    "chain.desc": "Кхочушбина дошен тӀаьххьара хӀарф. Ца юстийна!",
    "chain.score": "Сом",
    "chain.length": "ЗӀенг",
    "chain.nextLetter": "ТӀаьххьара хӀарф",
    "chain.placeholder": "Дош жайна…",
    "chain.last": "ТӀеххьара",
    "chain.errors": "{0}/{1} гӀалат — тӀехьа юха хӀотто",
    "chain.quit": "Юха",
    "chain.endTitle": "Декъал! 🔗",
    "chain.endDesc": "ЗӀенг чекхяьккха.",
    "chain.bestScore": "Уггаре дика сом",
    "chain.bestLength": "Уггаре деха зӀенг",
    "chain.gamesPlayed": "Ловзарш",
    "chain.retry": "Цхьа хӀума",
    "chain.home": "ТӀех",
    "chain.empty": "Келхне кхаа хӀан-хӀа — дерстина кхаьстийна.",
    "chain.btn": "ЗӀенг",
    "home.chain": "ЗӀенг",
    // Rehber (Tutorial)
  ...
  ru: {
    ...
    "stats.taSection": "На время ⏱",
    "stats.taBest": "Лучший счёт",
    "stats.taGames": "Игр",
    "stats.taWords": "Слов",
    "stats.daily": "Ежедневное слово",
    "stats.streakNow": "Текущая серия",
    "stats.streakBest": "Лучшая серия",
    "stats.coins": "Монеты",
    ...
    "ta.home": "На главную",
    // Цепочка
    "chain.title": "Цепочка слов",
    "chain.desc": "Каждое слово начинается с последней буквы предыдущего.",
    "chain.score": "Очки",
    "chain.length": "Длина",
    "chain.nextLetter": "Следующая буква",
    "chain.placeholder": "Введите слово…",
    "chain.last": "Последние",
    "chain.errors": "{0}/{1} ошибок — потом конец",
    "chain.quit": "Выход",
    "chain.endTitle": "Готово! 🔗",
    "chain.endDesc": "Цепочка завершена.",
    "chain.bestScore": "Лучший счёт",
    "chain.bestLength": "Лучшая длина",
    "chain.gamesPlayed": "Игр",
    "chain.retry": "Ещё раз",
    "chain.home": "На главную",
    "chain.empty": "Словарь пока пуст.",
    "chain.btn": "Цепочка",
    "home.chain": "Цепочка",
  },
  tr: {
    ...
    "stats.taSection": "Zamana Karşı ⏱",
    "stats.taBest": "En iyi skor",
    "stats.taGames": "Oyun",
    "stats.taWords": "Kelime",
    "stats.daily": "Günlük kelime",
    "stats.streakNow": "Mevcut seri",
    "stats.streakBest": "En iyi seri",
    "stats.coins": "Paralar",
    ...
    "ta.home": "Ana sayfa",
    // Zincir
    "chain.title": "Kelime Zinciri",
    "chain.desc": "Her kelime öncekinin son harfiyle başlar.",
    "chain.score": "Puan",
    "chain.length": "Zincir",
    "chain.nextLetter": "Sonraki harf",
    "chain.placeholder": "Kelime yaz…",
    "chain.last": "Son",
    "chain.errors": "{0}/{1} hata — sonra biter",
    "chain.quit": "Çıkış",
    "chain.endTitle": "Bitti! 🔗",
    "chain.endDesc": "Zincir tamamlandı.",
    "chain.bestScore": "En iyi puan",
    "chain.bestLength": "En uzun zincir",
    "chain.gamesPlayed": "Oyun",
    "chain.retry": "Tekrar",
    "chain.home": "Ana sayfa",
    "chain.empty": "Sözlük henüz boş.",
    "chain.btn": "Zincir",
    "home.chain": "Zincir",
