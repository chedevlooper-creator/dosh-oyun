...
const _S = {
  ...
  stats: { words: 0, coinsEarned: 0, coinsSpent: 0, hints: 0,
           ...
           chainBest: 0, chainGames: 0, chainLongest: 0 },
  lastDaily: "",
  lastGift: "",
...
export function hydrate(persisted){
  ...
  for(const k of ["words","coinsEarned","coinsSpent","hints","bonusWords","bestStreak","levelsDone","taBest","taGames","taWords","chainBest","chainGames","chainLongest"]){
